...
class PredictionPipeline:
    ...
    def save_input_files(self)-> str:
        ...
        try:
            ...
            input_csv_file.save(r"D:\DataScience\MLProjects\CementStrengthPrediction\prediction_artifacts\input_csv_file.csv")
    ...
    def get_predicted_dataframe(self, input_dataframe_path:pd.DataFrame):
        ...
        try:
            ...
            input_dataframe: pd.DataFrame = pd.read_csv(r"D:\DataScience\MLProjects\CementStrengthPrediction\prediction_artifacts\input_csv_file.csv")

            
            input_dataframe = input_dataframe.drop('Concrete compressive strength(MPa, megapascals) ', axis=1)
